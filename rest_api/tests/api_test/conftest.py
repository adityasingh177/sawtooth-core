...
class Setup:
    ...
    def _create_transactions(self):
        ...
        txns = [create_intkey_transaction("set", [] , 50 , self.signer) for i in range(BATCH_SIZE)]
        return txns
    ...
    def _expected_count(self,txns,batches):
        ...
        data['expected_batch_length'] = data['batch_count'] + length_batches
        data['expected_trn_length'] = data['transaction_count'] + length_transactions
        return data
